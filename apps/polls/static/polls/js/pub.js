...
var change_choice_has_extra_data = function (event) {
    ...
    added_choices_set[csq_id][c_id].has_extra_data = parseInt(event.target.value)
...
var submit = function (event) {
    ...
    var flag = false;
    if (!($('#title').val())){
        $('#div-id-title').addClass('has-error');
        $('#div-id-title span').show();
        flag = true;
    }
    if(!($('#title').val())){
        $('#div-id-desc').addClass('has-error');
        $('#div-id-desc span').show();
        flag = true
    }
    if (flag){
        return
